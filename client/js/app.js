...
class VoxlyApp {
    ...
    async loadPage(page) {
        ...
        try {
            ...
            // Reset scroll so a new section always starts from the top
...
// NOTE: VoxlyApp is booted by window.Auth after the session is verified.
// See client/js/auth.js — Auth.bootMainApp() constructs this once authenticated.
